  ...
  try {
    ...
    if (!groqResponse.ok) {
      ...
      return res.status(502).json({
        success: false,
        message: 'Assistant is temporarily unavailable. Please try again or contact support@gmkart.com.'
      });
    }

    const reply = data.choices?.[0]?.message?.content
      || "Sorry, I couldn't generate a response. Please contact support@gmkart.com.";
